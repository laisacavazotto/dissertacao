...
% Ajuste de espaçamento vertical para respeitar o limite de 20 páginas de
% desenvolvimento (excluindo Referências) exigido pela conferência, sem
% cortar texto. Reduz o espaço entre parágrafos, ao redor de tabelas/
% figuras e de legendas em relação ao padrão do sbc-template.sty, e
% torna esses espaços rígidos (sem "plus/minus") para que o \flushbottom
% do template não os estique de forma desigual em páginas mais vazias.
