...
\section{Metodologia} \label{sec:metodologia}
    ...
    \end{tikzpicture}}
    \caption{Fluxo de seleção dos estudos seguindo o protocolo PRISMA 2020. Identificação: 268 registros em cinco bases (Scopus 193, Science Direct 52, Periódicos CAPES 14, Teses CAPES 7, BDTD-USP 2). Triagem: aplicação de CI1--CI8 e CE1--CE9 resultou em 170 exclusões, sobretudo por menção superficial à IHD, uso clínico ou \textit{hardware} de baixo nível. Elegibilidade: 98 estudos remanescentes avaliados quanto à qualidade (30 com pontuação 1, 27 com 2, 41 com 3). Inclusão: \textit{corpus} final de 98 estudos (Scopus 81, Science Direct 14, Teses CAPES 3), 2014--2024, pico em 2020--2021.}
...
%A estratégia de identificação dos estudos integrou parâmetros temáticos e cronológicos. Estabeleceu-se uma \textit{string} de busca base focada no termo ``Human-Data Interaction'', configurada inicialmente para a base Scopus—incidindo sobre título, resumo e palavras-chave (\textit{TITLE-ABS-KEY}). Esta equação principal foi adaptada à sintaxe específica e às regras de indexação de cada uma das outras plataformas. O limite temporal da última década (2014-2024) foi parametrizado diretamente nos filtros de todas as bases, abrangendo desde os marcos conceituais pioneiros até os desenvolvimentos mais recentes da área\footnote{Disponível em: https://github.com/laisacavazotto/sbc-quixada/blob/main/Listas/Scopus\_Lista\_Artigos.txt. Acesso em: 20 maio 2026.}\footnote{Disponível em: https://github.com/laisacavazotto/sbc-quixada/blob/main/Listas/ScienceDirect\_Lista\_Artigos.txt. Acesso em: 20 maio 2026.}\footnote{Disponível em: https://github.com/laisacavazotto/sbc-quixada/blob/main/Listas/PeriodicosCAPES\_Lista\_Artigos.txt. Acesso em: 20 maio 2026.}\footnote{Disponível em: https://github.com/laisacavazotto/sbc-quixada/blob/main/Listas/TesesUSP\_Lista\_Teses.txt. Acesso em: 20 maio 2026.}\footnote{Disponível em: https://github.com/laisacavazotto/sbc-quixada/blob/main/Listas/TesesCAPES\_Lista\_Teses.txt. Acesso em: 20 maio 2026.}.
...
\subsection{Critérios de Seleção e Avaliação de Qualidade}
  ...
  Para estruturar a seleção dos estudos e sistematizar o conhecimento sobre o estado da arte em IHD no contexto urbano, foram estabelecidos critérios de inclusão (CI) e exclusão (CE), documentados nas \emph{tabelas resultantes da execução da RSL}\footnote{Disponível em: https://github.com/laisacavazotto/sbc-quixada/tree/main/Tabelas. Acesso em: 20 maio 2026.}\edef\footTabelas{\thefootnote}. Esses parâmetros, detalhados na Tabela~\ref{tab:criterios}, buscam equilibrar  abrangência teórica e especificidade prática, priorizando trabalhos replicáveis, disponíveis na íntegra e alinhados ao recorte temporal (2014–2024).
...
\begin{figure}[H]
    \centering
    \pdftooltip{\includegraphics[width=0.95\linewidth]{Imagens/distribuicao_artigos_por_ano_empilhado.png}}{Grafico de barras empilhadas: quantidade de artigos por ano (2014-2024) e base de dados (Scopus, Science Direct, Teses CAPES). Crescimento de 1 artigo em 2014-2015 para picos de 17 (2020), 16 (2021), 16 (2023) e 20 (2024), com queda para 10 em 2022. Scopus predomina em todos os anos (82,7 porcento do total).}
    \caption{Distribuição dos 98 artigos do \textit{corpus} por ano e fonte (2014--2024). Produção incipiente entre 2014--2019 (19 trabalhos, 19,4\%), concentrada no biênio 2020--2021 (33 trabalhos, 33,7\%) e em crescimento entre 2022--2024 (46 trabalhos, 46,9\%), com picos em 2020 (17), 2021 (16), 2023 (16) e 2024 (20) e queda pontual em 2022 (10). Scopus predomina em todos os anos (\textasciitilde82,7\%).}
...
A análise dos 98 trabalhos incluídos na Revisão Sistemática permitiu mapear a evolução histórica e estrutural da Interação Humano-Dados (IHD). A documentação completa encontra-se nas \emph{tabelas da RSL}\footnotemark[\footTabelas]. Com base na extração sistemática de evidências qualitativas, esta seção apresenta a síntese crítica da literatura, organizada em eixos temáticos que respondem de forma transversal e detalhada às Questões de Pesquisa (QPs e QPSs) delineadas no protocolo metodológico.
...
\end{table}
    ...
    Agradecemos ao Programa de Pós-Graduação em Sistemas de Informação da EACH-USP (PPgSI-EACH-USP) pelo suporte institucional, e à CAPES pelo financiamento via Programa de Demanda Social (processo nº 88887334955/2026-00). A primeira autora agradece ainda ao esposo, Felipe Cordeiro Alves Dias, e ao filho, Liam Cavasotti, pelo amor e apoio incondicional. Em conformidade com as diretrizes de transparência da conferência, declaramos o uso da IA Generativa \textit{Gemini 3.1 Pro} (\textit{Google}) e \textit{Claude Opus 4.7} (\textit{Anthropic}) para refinamento gramatical e estruturação sintática dos textos e da tabela de síntese.
